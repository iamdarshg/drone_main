...
//675262/1818841/2.50/4/3/Connector
...
(library Library_1
	...
	(patternDef "MM80302610RK0" (originalName "MM80302610RK0")
		(multiLayer
			(pad (padNum 1) (padStyleRef r110_70) (pt -0.800, 0.000) (rotation 0))
			(pad (padNum 2) (padStyleRef r110_70) (pt 0.800, 0.000) (rotation 0))
			(pad (padNum 3) (padStyleRef r50_40) (pt 0.000, -0.950) (rotation 90))
			(pad (padNum 4) (padStyleRef r50_40) (pt 0.000, 0.950) (rotation 90))
		)
	...
	(symbolDef "MM8030-2610RK0" (originalName "MM8030-2610RK0")
	...
	(compDef "MM8030-2610RK0" (originalName "MM8030-2610RK0") (compHeader (numPins 4) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MM8030-2610RK0"))
		(attachedPattern (patternNum 1) (patternName "MM80302610RK0")
			(numPads 4)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "MM8030-2610RK0")
		(attr "Mouser Part Number" "81-MM8030-2610RK0")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Murata-Electronics/MM8030-2610RK0?qs=Gufeu08L%2Fl1KuihYNYRiLA%3D%3D")
		(attr "Arrow Part Number" "MM8030-2610RK0")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/mm8030-2610rk0/murata-manufacturing?region=nac")
		(attr "Description" "1 Inner bore SWG Board Edge 0.45mm 11GHz 50 1.35mm SMD RF Connectors / Coaxial Connectors ROHS")
		(attr "<Hyperlink>" "https://datasheet.lcsc.com/lcsc/1811061528_Murata-Electronics-MM8030-2610RK0_C91632.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "MM8030-2610RK0.stp")

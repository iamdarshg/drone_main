...
(library Library_1
	...
	(compDef "NX3DV221TKX" (originalName "NX3DV221TKX") (compHeader (numPins 11) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "1D+") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "1D-") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "2D+") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "10" (pinName "VCC") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "S") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "D+") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "D-") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "__OE") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.nxp.com/docs/en/data-sheet/NX3DV221.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "NX3DV221TKX.stp")
